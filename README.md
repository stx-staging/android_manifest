...
## Repo Init ##
```bash
repo init -u https://github.com/stx-staging/android_manifest.git -b cp2a
```
## Sync Source ##
```bash
...
* `<branch>` - The git branch your change is based on; for projects using this manifest, it is `cp2a`
